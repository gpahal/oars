(function () {
    ...
    var e = tinymce.DOM;
    tinymce.create("tinymce.plugins.Grappelli", {init: function (t, n) {
        var r = this;
        ...
        t.addButton("grappelli_documentstructure", {title: "grappelli.grappelli_documentstructure_desc", cmd: "Grappelli_DocumentStructure"});
        ...
        return{longname: "Grappelli Plugin", author: "vonautomatisch (patrick kranzlmueller)", authorurl: "http://vonautomatisch.at", infourl: "http://code.google.com/p/django-grappelli/", version: "1.1"}
    }});
