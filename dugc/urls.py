...
urlpatterns = patterns('',
                       ...
                       url(r'^courses/(?P<course_id>\d+)/accepted/$', views.students_accepted,
                           name='students_accepted'),
                       url(r'^courses/(?P<course_id>\d+)/rejected/$', views.students_rejected,
                       ...
                       url(r'^request/(?P<request_id>\d+)/$', views.request_view, name='request'),
                       )